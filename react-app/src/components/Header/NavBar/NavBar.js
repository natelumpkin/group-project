...
const NavBar = () => {
  ...
  useEffect(() => {
    if (sessionUser) dispatch(followActions.getAllFollowers(sessionUser.id));
    if (sessionUser) dispatch(followActions.getAllFollowing(sessionUser.id));
  }, [dispatch, showMenu, sessionUser])
