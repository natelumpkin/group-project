...
const AboutPage = () => {
  ...
  const post = {
    ...
    text: 'We are Brad, Nate, Max, and David! This is a simple demo site to showcase our skills as engineers in training - check out our profiles in the footer! Feel free to make a user and post away, or use the demo user at the top to interact with the site. Have fun!',
    userId: 1
  }
