...
def seed_users():
    ...
    marnie = User(
        username='marnie', first_name="marnie", last_name="demouser", email='marnie@aa.io', password='password')
    bobbie = User(
        username='bobbie', first_name="bobbie", last_name="demouser", email='bobbie@aa.io', password='password')
